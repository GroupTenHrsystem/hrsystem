Ext.define('Admin.model.resumeArrange.ResumeArrangeModel', {
    ...
    fields: [	//需要修改
		...
		{type: 'date' ,name: 'firstTime'},
		{type: 'string' ,name: 'firstarragne'},
		{type: 'date' ,name: 'lastTime'},
		{type: 'string' ,name: 'lastarragne'},
