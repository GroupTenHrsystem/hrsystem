Ext.define('Admin.view.salaryStandard.SalaryStandardViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.salaryStandardViewController',
    /*Add*/
	openAddWindow:function(grid, rowIndex, colIndex){
			grid.up('salaryStandard').add(Ext.widget('salaryStandardAddWindow')).show();
	},
	submitAddForm:function(btn){
		...
		if(form.isValid()){
			...
			values.createTime = Ext.util.Format.date(curDate, 'Y/m/d H:i:s');
           	record.set(values);
          	record.save();
	...
	openEditWindow:function(grid, rowIndex, colIndex){
		...
		if (record ) {
			var win = grid.up('salaryStandard').add(Ext.widget('salaryStandardEditWindow'));
			win.show();
	...
	openSearchWindow:function(toolbar, rowIndex, colIndex){
		toolbar.up('grid').up('container').add(Ext.widget('salaryStandardSearchWindow')).show();
	},
