Ext.define('Admin.view.leaveapprove.LeaveApproveViewController', {
	...
	//部门经理审批
    onClickLeaveleaderAuditFormSubmitButton: function(btn) {
    ...
    //人事文员审批
    onClickLeaveAuditFormSubmitButton: function(btn) {
        var form = btn.up('form');
    	var values = form.getValues();
    	var url = 'leave/complete/' + values.taskId;
    	var variables = [{
    ...
    //销假
    onClickIreportBackFormSubmitButton: function(btn) {
    	var form = btn.up('form');
     	var values = form.getValues();
     	var url = 'leave/complete/' + values.taskId;
     	var variables = [{
