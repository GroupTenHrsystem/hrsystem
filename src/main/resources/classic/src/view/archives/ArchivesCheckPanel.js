Ext.define('Admin.view.archives.ArchivesCheckPanel', {
    extend: 'Ext.panel.Panel',
    xtype: 'archivesCheckPanel',
            ...
            columns: [
                ...
                {xtype: 'actioncolumn',cls: 'content-column', width: 120,dataIndex: 'bool',text: '操作',tooltip: 'edit ',
                    items: [
                        ...
                        {xtype: 'button', iconCls: 'x-fa fa-close'	,handler: 'openEditWindowFail'}
                    ]
                }
            ],
            tbar: [{
