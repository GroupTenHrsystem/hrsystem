Ext.define('Admin.view.training.FeedbackViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.feedbackViewController',
    /*Add*/
	openAddWindow:function(grid, rowIndex, colIndex){
			grid.up('feedback').add(Ext.widget('feedbackAddWindow')).show();
	},   
	...
	openEditWindow:function(grid, rowIndex, colIndex){
		...
		if (record ) {
			var win = grid.up('feedback').add(Ext.widget('feedbackEditWindow'));
			win.show();
	...
	quickSearch:function(btn){
		...
		if(searchField==='feedbackId'){
			var fieldValue = searchField.getValue;
			Ext.apply(store.proxy.extraParams, {feedbackId:searchValue});			
		}
