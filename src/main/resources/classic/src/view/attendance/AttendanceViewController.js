...
//	},
	...
	/*Quick Search*/
		...
		Ext.apply(store.proxy.extraParams, {employeName:"",employeNum:""});
		
		if(searchField==='employeName'){
			Ext.apply(store.proxy.extraParams, {employeName:searchValue});
		}
		if(searchField==='employeNum'){
			Ext.apply(store.proxy.extraParams, {employeNum:searchDataFieldValue});
		}
