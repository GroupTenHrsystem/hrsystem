...
//			grid.up('person').add(Ext.widget('personAddWindow')).show();
//	},
//	submitAddForm:function(btn){
//		var win    = btn.up('window');
//		var form = win.down('form');
//		var record = Ext.create('Admin.model.person.PersonModel');
//		var values  =form.getValues();//获取form数据
//           	record.set(values);
//          	record.save();
//          	Ext.data.StoreManager.lookup('personGridStore').load();
//          	win.close();
//	},
//	/* Clear Text */
...
//	},
    /*Edit*/
    openUpdateWindow:function(grid,rowIndex, colIndex){
//         var record = grid.getStore().getAt(0);
		//获取选中数据的字段值：console.log(record.get('id')); 或者 console.log(record.data.id);
//		if (record ) {
			grid.up('person').add(Ext.widget('personEditWindow')).show();
//			win.show();
