Ext.define('Admin.view.person.PersonViewController', {
 ...
 //           	record.set(values);
 //          	record.save();
 //          	Ext.data.StoreManager.lookup('personGridStroe').load();
 //          	win.close();
	// },
	// /* Clear Text */
 ...
 //         var record = grid.getStore().getAt(rowIndex);
	...
	// 	if (record ) {
	// 		var win = grid.up('person').add(Ext.widget('userEditWindow'));
	// 		win.show();
	...
	// 	var win    = btn.up('window');
	// 	var store = Ext.data.StoreManager.lookup('personGridStroe');
